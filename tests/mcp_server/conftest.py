...
import server  # noqa: E402  (import-time side effect: registers all 11 tools onto mcp_instance.mcp)
...
_TOOL_MODULES = (catalog_tools, sync_tools, watchlist_tools, rating_tools, list_tools)
